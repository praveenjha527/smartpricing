...
class TasksTest(TestCase):
    ...
    def test_process_all(self):
        ...
        suggested_price_obj=SuggestedPrices.objects.get(product=prod_obj,store=store_obj,responsible_factor=responsible_factor)
        suggested_price=suggested_price_obj.suggested_price
        self.assertEqual(suggested_price,61898)
